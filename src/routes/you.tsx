...
const ITEMS: HubItem[] = [
  ...
  },
  {
    ...
    title_el: "Εξοπλισμός",
    title_en: "Equipment",
    sub_el: "Στολές, πτερύγια, βαρίδια, checklist",
    sub_en: "Suits, fins, weights, checklist",
  },
  {
    to: "/rules",
    icon: BookOpen,
    ...
    title_el: "Κανόνες",
    title_en: "Rules",
    sub_el: "Πειθαρχίες & κανονισμοί αγώνων",
    sub_en: "Disciplines & competition rules",
  },
  {
    to: "/settings",
    icon: Settings,
    ...
    title_el: "Ρυθμίσεις",
    title_en: "Settings",
    sub_el: "Γλώσσα, λογαριασμός, προτιμήσεις",
    sub_en: "Language, account, preferences",
  },
];
...
function YouHub() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-foreground">{lang === "el" ? "Εσύ" : "You"}</h1>
        <p className="text-xs text-foreground/35">
          {lang === "el"
            ? "Το προφίλ, ο εξοπλισμός και οι ρυθμίσεις σου"
      ...
      {/* roadmap teasers */}
      <p className="pt-2 text-[0.6rem] font-bold tracking-[0.25em] text-foreground/25">
        ...
        {SOON.map(({ icon: Icon, title_el, title_en, sub_el, sub_en }, i) => (
          <div
            ...
            style={{
              ...
              border: "1px dashed rgba(var(--ink),0.08)",
            }}
          >
            <div
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full"
              style={{ background: "rgba(var(--ink),0.03)", color: "rgba(var(--ink),0.25)" }}
            >
              <Icon className="size-5" />
            </div>
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 text-[0.72rem] text-foreground/25">
                {lang === "el" ? sub_el : sub_en}
              </p>
            </div>
          </div>
