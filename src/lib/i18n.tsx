...
const en: Dict = {
  ...
  "react.less": "less",
  "react.likeOne": "like",
  "react.likeMany": "likes",
  // comments on a post/dive/catch/story
  ...
  "comment.send": "Send",
  // who liked
  "likers.title": "Liked by",
  "likers.empty": "No likes yet.",
  "common.close": "Close",
...
const el: Dict = {
  ...
  "react.ok": "Είμαι ΟΚ",
  "react.share": "Κοινοποίηση",
  "react.message": "Μήνυμα",
  "react.more": "περισσότερα",
  "react.less": "λιγότερα",
  "react.likeOne": "like",
  "react.likeMany": "likes",
  // σχόλια σε post/βουτιά/ψαριά/ιστορία
  "comment.open": "Σχόλιο",
  "comment.title": "Σχόλια",
  "comment.empty": "Κανένα σχόλιο ακόμα — γράψε πρώτος.",
  "comment.placeholder": "Γράψε ένα σχόλιο…",
  "comment.send": "Αποστολή",
  // ποιος έκανε like
  "likers.title": "Άρεσε σε",
  "likers.empty": "Κανένα like ακόμα.",
  ...
  "athlete.edit": "Επεξεργασία",
  "athlete.share": "Κοινοποίηση",
