...
alter table dives add column if not exists fins_brand  text;
alter table dives add column if not exists fins_model  text;
alter table dives add column if not exists foot_pocket text;
